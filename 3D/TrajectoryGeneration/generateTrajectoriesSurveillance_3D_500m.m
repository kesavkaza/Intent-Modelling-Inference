function [alltrajectories, traj_lens, initial_vels, changed_vels, vel_changepoints] = generateTrajectoriesSurveillance_3D_500m(planner, Nint, Nz, GRIDSIZE, gran_init, vel_range1, vel_range2)
...
Range2.y = [550, 610]/2; %[100, 160];
Range2.z = [20, 50];

Range3.x = [550, 610]/2; %[100, 125];
...
CROS1 = {Range1, Range2, Range3};
CROS2 = {Range4, Range3, Range2};
...
for x = 2:gran_init:9*GRIDSIZE(1)/10
    ...
    for zz = 1:nzx %5:gran_init:40
        ...
        for n = 1:Nint
            ...
            goal1 = quat(randi([Zone.x(1), Zone.x(2)]), randi([Zone.y(1), Zone.y(2)]), randi([Zone.z(1), Zone.z(2)]), randi([1,180]));
            goals{end+1} = goal1;
        end
...
for y = 2:gran_init:9*GRIDSIZE(2)/10
    ...
    for zz = 1:nzx %5:gran_init:40
        ...
        for n = 1:Nint %Nint:-1:1
            ...
            goal1 = quat(randi([Zone.x(1), Zone.x(2)]), randi([Zone.y(1), Zone.y(2)]),randi([Zone.z(1), Zone.z(2)]),randi([181,360]));
            goals{end+1} = goal1;
        end
