function [alltrajectories, traj_lens, initial_vels, changed_vels, vel_changepoints] = generateTrajectoriesHarmless_3D_500m(planner, Nint, Nz, GRIDSIZE, gran_init, vel_range1, vel_range2)
...
Range1.x = [500, 950]/2; %[100, 160];
Range1.y = [40, 240]/2;  %[20, 50];
Range1.z = [5, 100];

Range2.x = [500, 950]/2; %[20, 50];
Range2.y = [250, 626]/2; %[100, 160];
Range2.z = [5, 100];

Range22.x = [500, 950]/2; %[20, 50];
Range22.y = [250, 560]/2; %[100, 160];
Range22.z = [5, 100];

Range3.x = [250, 626]/2; %[100, 125];
Range3.y = [500, 950]/2; %[100, 190];
Range3.z = [5, 100];

Range32.x = [250, 560]/2; %[100, 125];
Range32.y = [500, 950]/2; %[100, 190];
Range32.z = [5, 100];

Range4.x = [40, 240]/2;  %[1, 200]; %[1, 50];
Range4.y = [500, 950]/2; %[100, 190];
Range4.z = [5, 100];

%Zones = {Range1, Range2, Range3, Range4};
CROS1 = {Range1, Range2, Range32};
CROS2 = {Range4, Range3, Range22};
...
for x = 2:gran_init:9*GRIDSIZE(1)/10
    ...
    for zz = 1:nzx %5:gran_init:40
        ...
        for n = 1:Nint
            ...
            goal1 = quat(randi([Zone.x(1), Zone.x(2)]), randi([Zone.y(1), Zone.y(2)]), randi([Zone.z(1), Zone.z(2)]), randi([1,360]));
            goals{end+1} = goal1;
        end
